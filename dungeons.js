...
var dungeons = [
    {
        name: "Deku Tree (ch)", x: "87.0%", y: "57.0%",
        chestlist: {
            'Lobby Chest': { isAvailable: () => true },
            'Falling Platform Chest': { isAvailable: () => true },
            'Falling Platform Side Chest': { isAvailable: () => true },
            '3 Pillars Chest': { isAvailable: () => true },
            '3 Pillars Side Chest': { isAvailable: () => true },
    ...
    },
    {
        ...
        chestlist: {
            ...
            'Maze Path First Chest': { isAvailable: () => (trackerData.items.EponasSong || trackerData.items.Hookshot >= 2) && trackerData.items.Hookshot && trackerData.items.Glove >= 2 && trackerData.items.SongofTime },
            'Maze Path Second Chest': { isAvailable: () => (trackerData.items.EponasSong || trackerData.items.Hookshot >= 2) && trackerData.items.Hookshot && trackerData.items.Glove >= 2 && trackerData.items.SongofTime },
            'Maze Path Third Chest': { isAvailable: () => (trackerData.items.EponasSong || trackerData.items.Hookshot >= 2) && trackerData.items.Hookshot && trackerData.items.Glove >= 2 && trackerData.items.SongofTime },
            'Maze Path Final Chest': { isAvailable: () => (trackerData.items.EponasSong || trackerData.items.Hookshot >= 2) && trackerData.items.Hookshot && trackerData.items.Glove >= 2 && trackerData.items.SongofTime},
            'Maze Right Central Chest': { isAvailable: () => (trackerData.items.EponasSong || trackerData.items.Hookshot >= 2) && trackerData.items.Hookshot && trackerData.items.Glove >= 2 && trackerData.items.Lens && trackerData.items.Magic && trackerData.items.SongofTime },
            'Maze Right Side Chest': { isAvailable: () => (trackerData.items.EponasSong || trackerData.items.Hookshot >= 2) && trackerData.items.Hookshot && trackerData.items.Glove >= 2 && trackerData.items.Lens && trackerData.items.Magic && trackerData.items.SongofTime },
            'Maze Right Side Key': { isAvailable: () => (trackerData.items.EponasSong || trackerData.items.Hookshot >= 2) && trackerData.items.Hookshot && trackerData.items.Glove >= 2 && trackerData.items.Lens && trackerData.items.Magic && trackerData.items.SongofTime },
    ...
    },
    {
        ...
        chestlist: {
            'Child Left Chest (ch)': { isAvailable: () => trackerData.items.RequiemofSpirit && (trackerData.items.Boomerang || trackerData.items.Slingshot) },
            'Child Right Chest (ch)': { isAvailable: () => trackerData.items.RequiemofSpirit && (trackerData.items.Boomerang || trackerData.items.Slingshot) },
            'Adult Lullaby Chest (ad)': { isAvailable: () => ((((trackerData.items.EponasSong && trackerData.items.HoverBoots) || trackerData.items.Hookshot >= 2) && trackerData.items.Lens && trackerData.items.Magic) || trackerData.items.RequiemofSpirit) && trackerData.items.Glove >= 2 && trackerData.items.Hookshot && trackerData.items.ZeldasLullaby },
            'Adult Silver Rupees Chest (ad)': { isAvailable: () => ((((trackerData.items.EponasSong && trackerData.items.HoverBoots) || trackerData.items.Hookshot >= 2) && trackerData.items.Lens && trackerData.items.Magic) || trackerData.items.RequiemofSpirit) && trackerData.items.Glove >= 2 && (trackerData.items.Bow || trackerData.items.Hookshot || trackerData.items.Bombs) },
            'Adult Suns on Wall Left Chest (ad)': { isAvailable: () => ((((trackerData.items.EponasSong && trackerData.items.HoverBoots) || trackerData.items.Hookshot >= 2) && trackerData.items.Lens && trackerData.items.Magic) || trackerData.items.RequiemofSpirit) && trackerData.items.Glove >= 2 },
            'Adult Suns on Wall Right Chest (ad)': { isAvailable: () => ((((trackerData.items.EponasSong && trackerData.items.HoverBoots) || trackerData.items.Hookshot >= 2) && trackerData.items.Lens && trackerData.items.Magic) || trackerData.items.RequiemofSpirit) && trackerData.items.Glove >= 2 },
            'Bottom of Statue Chest': { isAvailable: () => ((trackerData.items.RequiemofSpirit && trackerData.items.Bombs) || (((((trackerData.items.EponasSong && trackerData.items.HoverBoots) || trackerData.items.Hookshot >= 2) && trackerData.items.Lens && trackerData.items.Magic) || trackerData.items.RequiemofSpirit) && trackerData.items.Glove >= 2)) && trackerData.items.Magic && (trackerData.items.Dins || (trackerData.items.Fire && trackerData.items.Bow && trackerData.items.Glove >= 2)) },
            'Child Climb East Chest (ch)': { isAvailable: () => ((trackerData.items.RequiemofSpirit && (trackerData.items.Boomerang || trackerData.items.Slingshot)) || (((((trackerData.items.EponasSong && trackerData.items.HoverBoots) || trackerData.items.Hookshot >= 2) && trackerData.items.Lens && trackerData.items.Magic) || trackerData.items.RequiemofSpirit) && trackerData.items.Glove >= 2 && (trackerData.items.Hookshot || trackerData.items.Bow))) },
            'Child Climb North Chest (ch)': { isAvailable: () => ((trackerData.items.RequiemofSpirit && (trackerData.items.Boomerang || trackerData.items.Slingshot)) || (((((trackerData.items.EponasSong && trackerData.items.HoverBoots) || trackerData.items.Hookshot >= 2) && trackerData.items.Lens && trackerData.items.Magic) || trackerData.items.RequiemofSpirit) && trackerData.items.Glove >= 2 && (trackerData.items.Hookshot || trackerData.items.Bow))) },
            ...
            'Statue Hand Chest (ad)': { isAvailable: () => (((((trackerData.items.EponasSong && trackerData.items.HoverBoots) || trackerData.items.Hookshot >= 2) && trackerData.items.Lens && trackerData.items.Magic) || trackerData.items.RequiemofSpirit) && trackerData.items.Glove >= 2) && trackerData.items.ZeldasLullaby },
            'NE Main Room Chest (ad)': { isAvailable: () => (((((trackerData.items.EponasSong && trackerData.items.HoverBoots) || trackerData.items.Hookshot >= 2) && trackerData.items.Lens && trackerData.items.Magic) || trackerData.items.RequiemofSpirit) && trackerData.items.Glove >= 2) && trackerData.items.ZeldasLullaby && trackerData.items.Hookshot },
            ...
            'Mirror Shield Chest (ad)': { isAvailable: () => (((((trackerData.items.EponasSong && trackerData.items.HoverBoots) || trackerData.items.Hookshot >= 2) && trackerData.items.Lens && trackerData.items.Magic) || trackerData.items.RequiemofSpirit) && trackerData.items.Glove >= 2) },
            'Near Four Armos Chest (ad)': { isAvailable: () => (((((trackerData.items.EponasSong && trackerData.items.HoverBoots) || trackerData.items.Hookshot >= 2) && trackerData.items.Lens && trackerData.items.Magic) || trackerData.items.RequiemofSpirit) && trackerData.items.Glove >= 2) && trackerData.items.MirrorShield },
            'Hallway Left Invisible Chest (ad)': { isAvailable: () => (((((trackerData.items.EponasSong && trackerData.items.HoverBoots) || trackerData.items.Hookshot >= 2) && trackerData.items.Lens && trackerData.items.Magic) || trackerData.items.RequiemofSpirit) && trackerData.items.Glove >= 2) && trackerData.items.Magic && trackerData.items.Lens },
            'Hallway Right Invisible Chest (ad)': { isAvailable: () => (((((trackerData.items.EponasSong && trackerData.items.HoverBoots) || trackerData.items.Hookshot >= 2) && trackerData.items.Lens && trackerData.items.Magic) || trackerData.items.RequiemofSpirit) && trackerData.items.Glove >= 2) && trackerData.items.Magic && trackerData.items.Lens },
            'Boss Key Chest (ad)': { isAvailable: () => (((((trackerData.items.EponasSong && trackerData.items.HoverBoots) || trackerData.items.Hookshot >= 2) && trackerData.items.Lens && trackerData.items.Magic) || trackerData.items.RequiemofSpirit) && trackerData.items.Glove >= 2) && trackerData.items.ZeldasLullaby && trackerData.items.Bow && trackerData.items.Hookshot && (trackerData.items.Bombs || trackerData.items.Hammer) },
            'Topmost Sun on Wall Chest (ad)': { isAvailable: () => (((((trackerData.items.EponasSong && trackerData.items.HoverBoots) || trackerData.items.Hookshot >= 2) && trackerData.items.Lens && trackerData.items.Magic) || trackerData.items.RequiemofSpirit) && trackerData.items.Glove >= 2) && (trackerData.items.Hookshot || trackerData.items.Bow || trackerData.items.Bombs) && trackerData.items.MirrorShield },
            'Twinrova (ad)': { isAvailable: () => (((((trackerData.items.EponasSong && trackerData.items.HoverBoots) || trackerData.items.Hookshot >= 2) && trackerData.items.Lens && trackerData.items.Magic) || trackerData.items.RequiemofSpirit) && trackerData.items.Glove >= 2 && trackerData.items.MirrorShield && trackerData.items.Bombs && trackerData.items.Hookshot) }
        },
        isBeatable: function() {
    ...
    {
        name: "Bottom of the Well (ch)", x: "68.0%", y: "23.0%",
        chestlist: {
    ...
    },
    {
        ...
        chestlist: {
            'Left Side Main Room Chest': { isAvailable: () => trackerData.items.Bombs || trackerData.items.Hammer || trackerData.items.Glove },
            'Near Huge Stairs Chest': { isAvailable: () => trackerData.items.Bombs || trackerData.items.Hammer || trackerData.items.Glove },
            'Spike Trap Platform Chest': { isAvailable: () => trackerData.items.Bombs || trackerData.items.Hammer || trackerData.items.Glove },
            'End of First Bridge Chest': { isAvailable: () => (trackerData.items.Bombs || trackerData.items.Hammer || trackerData.items.Glove) && (trackerData.items.Slingshot || trackerData.items.Bow || trackerData.items.HoverBoots) },
            'End of Second Bridge Chest': { isAvailable: () => (trackerData.items.Slingshot || trackerData.items.Bow || trackerData.items.HoverBoots) && (trackerData.items.Bombs || ((trackerData.items.Bow || trackerData.items.HoverBoots) && trackerData.items.Hammer)) },
    ...
    {
        name: "Fire Temple (ad)", x: "68.0%", y: "06.5%",
        chestlist: {
            ...
            'Fire Chase Cage Chest': { isAvailable: () => trackerData.items.GoronTunic && (trackerData.items.BoleroofFire || (trackerData.items.HoverBoots || trackerData.items.Hookshot)) && trackerData.items.Glove && (trackerData.items.Bombs || trackerData.items.Bow || trackerData.items.Hookshot) },
            'Fire Maze Side Room Chest': { isAvailable: () => trackerData.items.GoronTunic && (trackerData.items.BoleroofFire || (trackerData.items.HoverBoots || trackerData.items.Hookshot)) && trackerData.items.Glove && (trackerData.items.Bombs || trackerData.items.Bow || trackerData.items.Hookshot) },
            'Fire Maze Center Goron Chest': { isAvailable: () => trackerData.items.GoronTunic && (trackerData.items.BoleroofFire || (trackerData.items.HoverBoots || trackerData.items.Hookshot)) && trackerData.items.Glove && (trackerData.items.Bombs || trackerData.items.Bow || trackerData.items.Hookshot) && trackerData.items.Hammer },
    ...
    {
        name: "Forest Temple (ad)", x: "78.5%", y: "39.0%",
        chestlist: {
    ...
    {
        name: "Ganon's Castle (ad)", x: "52.0%", y: "10.0%",
        chestlist: {
    ...
    },
    {
        ...
        chestlist: {
            ...
            "Ganon's Castle Fairy (ad)": { isAvailable: () => trackerData.items.Glove >= 3 && trackerData.items.ZeldasLullaby },
            'Prelude of Light (ad)': { isAvailable: () => trackerData.items.ForestMedallion },
            'Light Arrows (ad)': { isAvailable: () => trackerData.items.ShadowMedallion && trackerData.items.SpiritMedallion }
        },
        isBeatable: function() { return this.canGetChest(); },
        canGetChest: function() { return generalCanGetChest(this.chestlist); }
    },
    {
        ...
        chestlist: {
            'Anju as Adult (ad)': { isAvailable: () => true },
            "Anju's Chickens (ch)": { isAvailable: () => true },
            ...
            'Dampe Race 1 (ad)': { isAvailable: () => true },
            'Dampe Race 2 (ad)': { isAvailable: () => true },
    ...
    },
    {
        ...
        chestlist: {
            ...
            'Hot Rodder Goron (ch)': { isAvailable: () => trackerData.items.Bombs },
            'Link the Goron (ad)': { isAvailable: () => trackerData.items.Glove || trackerData.items.Bombs || trackerData.items.Bow },
            'Spinning Pot Heart Piece (ch)': { isAvailable: () => (trackerData.items.Glove || trackerData.items.Bombs) && (trackerData.items.ZeldasLullaby || (trackerData.items.Magic && trackerData.items.Dins)) },
            "Darunia's Joy (ch)": { isAvailable: () => trackerData.items.ZeldasLullaby && trackerData.items.SariasSong }
        },
        isBeatable: function() { return this.canGetChest(); },
        canGetChest: function() { return generalCanGetChest(this.chestlist); }
    },
    {
        ...
        chestlist: {
            'Skull Kid (ch)': { isAvailable: () => trackerData.items.SariasSong },
            'Deku Salesman (ch)': { isAvailable: () => true },
            'Ocarina Memory Game (ch)': { isAvailable: () => true },
            'Target in Woods (ch)': { isAvailable: () => trackerData.items.Slingshot },
            ...
            "Saria's Song (ch)": { isAvailable: () => true },
            'Minuet of Forest (ad)': { isAvailable: () => trackerData.items.SariasSong || trackerData.items.MinuetofForest },
            'Deku Theater Skull Mask (ch)': { isAvailable: () => true },
            'Deku Theater Mask of Truth (ch)': { isAvailable: () => trackerData.items.SariasSong && trackerData.items.KokiriEmerald && trackerData.items.GoronRuby && trackerData.items.ZoraSapphire }
        },
        isBeatable: function() { return this.canGetChest(); },
        canGetChest: function() { return generalCanGetChest(this.chestlist); }
    },
    ...
    },
    {
        ...
        chestlist: {
            ...
            'Bolero of Fire (ad)': { isAvailable: () => trackerData.items.BoleroofFire || (trackerData.items.HoverBoots && (trackerData.items.Hammer || trackerData.items.Bombs || trackerData.items.Glove)) || (trackerData.items.Hookshot && trackerData.items.Glove) },
            ...
            'Crater Magic Bean Heart Piece (ad)': { isAvailable: () => (trackerData.items.Bombs || trackerData.items.Scale) && trackerData.items.BoleroofFire },
            'Crater Grotto': { isAvailable: () => trackerData.items.Bombs || trackerData.items.Hammer },
            'Crater Fairy Fountain (ad)': { isAvailable: () => trackerData.items.Hammer && trackerData.items.ZeldasLullaby && (trackerData.items.Glove || (trackerData.items.BoleroofFire && trackerData.items.Hookshot) || trackerData.items.HoverBoots) },
            'Summit Fairy Fountain': { isAvailable: () => (trackerData.items.Bombs || trackerData.items.Hammer) && trackerData.items.ZeldasLullaby },
            'Biggoron Sword (ad)': { isAvailable: () => trackerData.items.Bombs || trackerData.items.Hammer || (trackerData.items.BoleroofFire && (trackerData.items.HoverBoots || trackerData.items.Hookshot)) || trackerData.items.Glove }
        },
        isBeatable: function() { return this.canGetChest(); },
        canGetChest: function() { return generalCanGetChest(this.chestlist); }
    }
...
const chests = [
    { name: "Kokiri Sword Chest (ch)", x: "76.0%", y: "63.5%", isAvailable: () => "available" },
    ...
    { name: "Talon's Chickens Minigame (ch)", x: "49.0%", y: "38.0%", isAvailable: () => "available" },
    { name: "Epona's Song (ch)", x: "47.0%", y: "41.5%", isAvailable: () => "available" },
    { name: "Lon Lon Heart Piece", x: "44.0%", y: "43.5%", isAvailable: () => "available" },
    { name: "Underwater Bottle (ch)", x: "38.6%", y: "80.0%", isAvailable: () => trackerData.items.Scale ? "available" : "unavailable" },
    ...
    { name: "Lab Roof Heart Piece (ad)", x: "35.2%", y: "74.0%", isAvailable: () => (trackerData.items.Scale || trackerData.items.Bombs || trackerData.items.Hookshot) ? "available" : "unavailable" },
    { name: "Child Fishing (ch)", x: "45.0%", y: "78.0%", isAvailable: () => trackerData.items.KokiriSword ? "available" : "unavailable" },
    { name: "Adult Fishing (ad)", x: "46.9%", y: "78.0%", isAvailable: () => (trackerData.items.Hookshot || trackerData.items.Scale || trackerData.items.Bombs) ? "available" : "unavailable" },
    { name: "Gerudo Valley Hammer Rocks Chest (ad)", x: "22.0%", y: "38.0%", isAvailable: () => ((trackerData.items.EponasSong || trackerData.items.Hookshot >= 2) && trackerData.items.Hammer) ? "available" : "unavailable" },
    ...
    { name: "Gerudo Fortress Rooftop Chest (ad)", x: "18.8%", y: "23.0%", isAvailable: () => ((trackerData.items.EponasSong || trackerData.items.Hookshot >= 2) && trackerData.items.HoverBoots || trackerData.items.Hookshot >= 2) ? "available" : "unavailable" },
    { name: "Horseback Archery Game 1000pts (ad)", x: "21.7%", y: "28.0%", isAvailable: () => ((trackerData.items.EponasSong || trackerData.items.Hookshot >= 2) && trackerData.items.EponasSong && trackerData.items.Bow) ? "available" : "unavailable" },
    { name: "Horseback Archery Game 1500pts (ad)", x: "23.5%", y: "28.0%", isAvailable: () => ((trackerData.items.EponasSong || trackerData.items.Hookshot >= 2) && trackerData.items.EponasSong && trackerData.items.Bow) ? "available" : "unavailable" },
    ...
    { name: "Desert Colossus Heart Piece (ad)", x: "06.4%", y: "23.5%", isAvailable: () => (trackerData.items.RequiemofSpirit && (trackerData.items.Bombs || trackerData.items.Scale)) ? "available" : "unavailable" },
    { name: "Frog Ocarina Game (ch)", x: "79.8%", y: "32.0%", isAvailable: () => ((trackerData.items.Scale || trackerData.items.Bombs) && trackerData.items.ZeldasLullaby && trackerData.items.SariasSong && trackerData.items.SunsSong && trackerData.items.EponasSong && trackerData.items.SongofTime && trackerData.items.SongofStorms) ? "available" : "unavailable" },
    { name: "Frogs in the Rain (ch)", x: "78.0%", y: "32.0%", isAvailable: () => ((trackerData.items.Scale || trackerData.items.Bombs) && trackerData.items.SongofStorms) ? "available" : "unavailable" },
