...
var dungeons = [
    ...
    },
    {
        ...
        chestlist: {
            ...
            'Maze Path First Chest': { isAvailable: () => (trackerData.items.EponasSong || trackerData.items.Hookshot >= 2) && trackerData.items.Hookshot && trackerData.items.Glove >= 2 && trackerData.items.SongofTime && trackerData.items.Bow },
            'Maze Path Second Chest': { isAvailable: () => (trackerData.items.EponasSong || trackerData.items.Hookshot >= 2) && trackerData.items.Hookshot && trackerData.items.Glove >= 2 && trackerData.items.SongofTime && trackerData.items.Bow },
            'Maze Path Third Chest': { isAvailable: () => (trackerData.items.EponasSong || trackerData.items.Hookshot >= 2) && trackerData.items.Hookshot && trackerData.items.Glove >= 2 && trackerData.items.SongofTime && trackerData.items.Bow },
            'Maze Path Final Chest': { isAvailable: () => (trackerData.items.EponasSong || trackerData.items.Hookshot >= 2) && trackerData.items.Hookshot && trackerData.items.Glove >= 2 && trackerData.items.SongofTime && trackerData.items.Bow },
